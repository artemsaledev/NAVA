...
if($name=="" or $email=="" or $tel==""){
    ...
    $to = "timmaddy01@gmail.com"; /* Адрес, куда отправляем письма*/
    $subject = "Заказ звонка с лендинга Геккон"; /*Тема письма*/
    $headers = "MIME-Version: 1.0\r\n";
    $headers .= "Content-type: text/html; charset=utf-8\r\n";
    $headers .= "From: <artemsaledev@gmail.com>\r\n";/*ОТ КОГО*/
    ...
    if ($send == "true")
    {
        echo "<p style='color: #e12623; margin: 30px 30px 0;'>Ваше сообщение отправлено. Мы ответим вам в ближайшее время.\r\n</p>";
    }
    /*ЕСЛИ ПИСЬМО НЕ УДАЛОСЬ ОТПРАВИТЬ ВЫВОДИМ СООБЩЕНИЕ ОБ ОШИБКЕ*/
    else
    {
        echo "<p style='color: #e12623; margin: 30px 30px 0;'>Не удалось отправить, попробуйте снова!</p>";
    }
}
?>